...
@Component({
	selector: 'notas-finales-alumno',
	templateUrl: '../views/notas-finales-alumno.html',
	providers: [UsuarioService, CursoService, AlumnoService, MateriaService, NotaModuloService, ModuloService, NotaMateriaService]

})

export class NotasFinalesAlumno implements OnInit{
	...
	public notasFinalesMateria:NotaMateria[];
	public notasFinalesModulo:NotaModulo[];
												...
												this._notaMateriaService.getNotasMateriaYModuloPorAlumno(this.token, this.alumno._id).subscribe(
													response=>{
														if(!response.notasMateria){
															...
															this.notasFinalesMateria= response.notasMateriaFinal;
															this.notasFinalesModulo= response.notasModuloFinal;
