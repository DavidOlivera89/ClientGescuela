...
@Component({
	selector: 'notas-finales-materia-curso',
	templateUrl: '../views/notaFinalesCurso.html',
	providers: [UsuarioService, CursoService, ObservacionCursoService, MateriaService, NotaMateriaService, ModuloService]

})

export class NotasFinalesMateriaCursoComponent implements OnInit{
